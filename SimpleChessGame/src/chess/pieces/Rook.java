...
public final class Rook extends Piece implements InfiniteMove{
    public Rook(final int index, final int x, final int y, final COLOR color) {
        super(index, x, y, color, 500, true);
    }
